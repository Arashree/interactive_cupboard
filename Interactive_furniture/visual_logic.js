...
registerOnClick('slab1', false, false, [0,1,2], function() {
  replaceTexture('wood0', 'wood_basecolor_1.jpg', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('slab2', false, false, [0,1,2], function() {
  replaceTexture('wood0', 'wood_basecolor_1.jpg', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('slab3', false, false, [0,1,2], function() {
  replaceTexture('wood0', 'wood_basecolor_1.jpg', 'wood_basecolor_3.jpg', function() {});
}, function() {});

status2 = 'open';

registerOnClick('porte', false, false, [0,1,2], function() {
  if (status2 == 'open') {

    operateAnimation('PLAY', 'porte', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, false);
    ...
    operateAnimation('PLAY', 'porte', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, true);
